...
export const metadata = {
  title: "Grow a Garden Pets That Reduce Cooldown | Complete Guide",
  description: "Discover Grow a Garden pets that reduce cooldown. Includes Dilophosaurus, Lion, Queen Bee, and more with detailed stats and strategies for maximum efficiency.",
  keywords: ["grow a garden pets that reduce cooldown"],
  metadataBase: new URL('https://www.growagardenplayer.com'),
  alternates: {
    canonical: '/posts/grow-a-garden-pets-that-reduce-cooldown',
  },
  openGraph: {
    title: "Grow a Garden Pets That Reduce Cooldown",
    description: "Discover Grow a Garden pets that reduce cooldown. Includes Dilophosaurus, Lion, Queen Bee, and more with detailed stats and strategies for maximum efficiency.",
    url: 'https://www.growagardenplayer.com/posts/grow-a-garden-pets-that-reduce-cooldown',
    images: [{ url: '/images/cooldown-pets-banner.jpg' }],
    type: 'article',
  },
};
...
const breadcrumbJsonLd = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Grow a Garden Pets That Reduce Cooldown",
      "item": "https://www.growagardenplayer.com/posts/grow-a-garden-pets-that-reduce-cooldown"
    }
  ]
};
  ...
  <nav aria-label="Breadcrumb" className="mb-6">
    <ol className="flex items-center gap-2 text-sm text-gray-600">
      ...
      <li className="text-gray-900 font-medium" aria-current="page">
        Grow a Garden Pets That Reduce Cooldown
      </li>
    </ol>
  </nav>
);
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <article className="prose prose-lg prose-green max-w-none">
          ...
          <section id="dilophosaurus">
            ...
            <ArticleImage src="/images/dilophosaurus.jpg" alt="Dilophosaurus pet - Grow a Garden Roblox" caption="Reliable, frequent cooldown advancement with bonus XP potential." />
          ...
          <section id="griffin">
            ...
            <ArticleImage src="/images/griffin.jpg" alt="Griffin pet - Grow a Garden Roblox" caption="Hybrid support pet that boosts cooldowns and spreads a strong mutation." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="hotdog-dachshund">
            ...
            <ArticleImage src="/images/hotdog-daschund.jpg" alt="Hotdog Dachshund pet - Grow a Garden Roblox" caption="Fastest cooldown-supporting pet with area-based buffs." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="lion">
            ...
            <ArticleImage src="/images/lion.jpg" alt="Lion pet - Grow a Garden Roblox" caption="Strong burst of cooldown reduction shared across your entire pet team." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="meerkat">
            ...
            <ArticleImage src="/images/meerkat.jpg" alt="Meerkat pet - Grow a Garden Roblox" caption="Can chain multiple cooldown boosts if the repeat chance triggers." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="oxpecker">
            ...
            <ArticleImage src="/images/oxpecker.jpg" alt="Oxpecker pet - Grow a Garden Roblox" caption="A must-have in Safari-heavy teams to make all their abilities cycle faster." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="peach-wasp">
            ...
            <ArticleImage src="/images/peach-wasp.jpg" alt="Peach Wasp pet - Grow a Garden Roblox" caption="Steady cooldown boosts plus the Plasma mutation for extra value." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="peacock">
            ...
            <ArticleImage src="/images/peacock.jpg" alt="Peacock pet - Grow a Garden Roblox" caption="One of the best AoE cooldown boosters for large gardens." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="queen-bee">
            ...
            <ArticleImage src="/images/queen-bee.jpg" alt="Queen Bee pet - Grow a Garden Roblox" caption="Its ability refresh is extremely strong for top-tier cooldown-intensive pets." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="red-squirrel">
            ...
            <ArticleImage src="/images/red-squirrel.jpg" alt="Red Squirrel pet - Grow a Garden Roblox" caption="Pairs perfectly with Fall pets to speed up their cycles." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="spider">
            ...
            <ArticleImage src="/images/spider.jpg" alt="Spider pet - Grow a Garden Roblox" caption="A powerful area buff that helps both pets and plants simultaneously." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="tarantula-hawk">
            ...
            <ArticleImage src="/images/tarantula-hawk.jpg" alt="Tarantula Hawk pet - Grow a Garden Roblox" caption="Very frequent cooldown boosts plus a strong mutation bonus." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="wasp">
            ...
            <ArticleImage src="/images/wasp.jpg" alt="Wasp pet - Grow a Garden Roblox" caption="A solid utility pet with reliable cooldown advancement." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
