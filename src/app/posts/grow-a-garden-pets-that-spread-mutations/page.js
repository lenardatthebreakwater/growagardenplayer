...
export const metadata = {
  title: "Grow a Garden Pets That Spread Mutations | Complete Guide",
  description: "Discover the top 14 Grow a Garden pets that spread mutations. Includes T-Rex, Phoenix, Corrupted Kitsune, and more with detailed stats and strategies to maximize fruit value.",
  keywords: ["grow a garden pets that spread mutations"],
  metadataBase: new URL('https://www.growagardenplayer.com'),
  alternates: {
    canonical: '/posts/grow-a-garden-pets-that-spread-mutations',
  },
  openGraph: {
    title: "Grow a Garden Pets That Spread Mutations",
    description: "Discover the top 14 Grow a Garden pets that spread mutations. Includes T-Rex, Phoenix, Corrupted Kitsune, and more with detailed stats and strategies to maximize fruit value.",
    url: 'https://www.growagardenplayer.com/posts/grow-a-garden-pets-that-spread-mutations',
    images: [{ url: '/images/mutation-pets-banner.jpg' }],
    type: 'article',
  },
};
...
const breadcrumbJsonLd = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Grow a Garden Pets That Spread Mutations",
      "item": "https://www.growagardenplayer.com/posts/grow-a-garden-pets-that-spread-mutations"
    }
  ]
};
  ...
  <nav aria-label="Breadcrumb" className="mb-6">
    <ol className="flex items-center gap-2 text-sm text-gray-600">
      ...
      <li className="text-gray-900 font-medium" aria-current="page">
        Grow a Garden Pets That Spread Mutations
      </li>
    </ol>
  </nav>
);
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="mb-10">
          <Badge variant="pets" className="mb-4">{articleData.category}</Badge>
        ...
        <article className="prose prose-lg prose-green max-w-none">
          ...
          <section id="badger">
            ...
            <ArticleImage src="/images/badger.jpg" alt="Badger pet - Grow a Garden Roblox" caption="Applies the Cracked mutation rapidly over time." />
          ...
          <section id="cockatrice">
            ...
            <ArticleImage src="/images/cockatrice.jpg" alt="Cockatrice pet - Grow a Garden Roblox" caption="A versatile pet mixing mutation spreading, XP farming, and fruit upgrading." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="corrupted-kitsune">
            ...
            <ArticleImage src="/images/corrupted-kitsune.jpg" alt="Corrupted Kitsune pet - Grow a Garden Roblox" caption="A top-tier pet for applying extremely high mutation multipliers." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="dark-spriggan">
            ...
            <ArticleImage src="/images/dark-spriggan.jpg" alt="Dark Spriggan pet - Grow a Garden Roblox" caption="Spreads the powerful Blight mutation to a massive number of fruits." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="giraffe">
            ...
            <ArticleImage src="/images/giraffe.jpg" alt="Giraffe pet - Grow a Garden Roblox" caption="Great for tall fruit farms and boosting early growth." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="griffin">
            ...
            <ArticleImage src="/images/griffin.jpg" alt="Griffin pet - Grow a Garden Roblox" caption="Supports your pet team while spreading strong mutations." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="kappa">
            ...
            <ArticleImage src="/images/kappa.jpg" alt="Kappa pet - Grow a Garden Roblox" caption="The Kappa offers consistent AoE mutation spreading." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="lion">
            ...
            <ArticleImage src="/images/lion.jpg" alt="Lion pet - Grow a Garden Roblox" caption="A strong team-support pet that also spreads Safari mutations." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="phoenix">
            ...
            <ArticleImage src="/images/phoenix.jpg" alt="Phoenix pet - Grow a Garden Roblox" caption="A fast, active mutation spreader that also strengthens newly mutated pets." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="spriggan">
            ...
            <ArticleImage src="/images/spriggan.jpg" alt="Spriggan pet - Grow a Garden Roblox" caption="Spreads the Bloom mutation through its root system." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="sugar-glider">
            ...
            <ArticleImage src="/images/sugar-glider.jpg" alt="Sugar Glider pet - Grow a Garden Roblox" caption="Useful for transferring specific mutations across targeted fruits." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="t-rex">
            ...
            <ArticleImage src="/images/t-rex.jpg" alt="T-Rex pet - Grow a Garden Roblox" caption="The T-Rex rapidly clones valuable mutations across your garden." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="trapdoor-spider">
            ...
            <ArticleImage src="/images/trapdoor-spider.jpg" alt="Trapdoor Spider pet - Grow a Garden Roblox" caption="Clears fruits while triggering mutations in a large radius." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
          ...
          <section id="wolf">
            ...
            <ArticleImage src="/images/wolf.jpg" alt="Wolf pet - Grow a Garden Roblox" caption="Spreads mutations quickly and gives a fun mobility buff." />
            <p className="font-bold text-[#2B5E3A] mb-2 uppercase text-sm tracking-wide">Ability:</p>
