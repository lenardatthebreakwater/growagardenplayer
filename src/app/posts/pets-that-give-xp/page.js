...
const articleData = {
  slug: "best-pets-for-xp-farming",
  title: "Grow a Garden Best Pets That Give XP to Other Pets",
  description: "Find the best Grow a Garden pets like the Capybara, Blood Owl, Dilophosaurus, and Wisp that grant passive XP to your other pets for faster leveling and mutation farming.",
  datePublished: "2025-12-08T13:00:00Z", // Use current time
  dateModified: "2025-12-08T13:00:00Z",
  authorName: "GardenHub Contributor",
  // The main image for SEO should ideally be a collage/header image
...
export const metadata = {
  ...
  keywords: ['Grow a Garden Pets', 'XP Pets', 'Capybara', 'Blood Owl', 'Dilophosaurus', 'Wisp', 'Pet Leveling'],
  openGraph: {
    title: articleData.title,
    description: articleData.description,
...
export default function ArticlePage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Header (Simplified for Article Page) */}
