...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.growagardenplayer.com/posts/grow-a-garden-pets-that-give-xp',
  },
  openGraph: {
    title: "Best Grow a Garden Pets That Give XP",
    description: "Find out the best Grow a Garden pets that give XP to other pets for faster leveling.",
    ...
    type: 'article',
    images: [{ url: '/images/xp-pets-header.jpg' }],
  },
};
...
// RESTORED SEO TABLE OF CONTENTS
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 selection:bg-pink-100">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <article className="prose max-w-none text-gray-800">
          ...
          <ArticleImage src="/images/capybara.jpg" alt="The Capybara pet in Grow a Garden, often used for XP farming due to its area-of-effect ability." caption="The adorable and highly functional Capybara." />
          <p>
          ...
          <ArticleImage src="/images/blood-owl.jpg" alt="The Blood Owl pet in Grow a Garden, recognized for its ability to grant XP to all active pets regardless of distance." caption="The Blood Owl offers global XP generation." />
          <p>
          ...
          <ArticleImage src="/images/dilophosaurus.jpg" alt="The Dilophosaurus pet in Grow a Garden spitting venom, which advances cooldowns or grants large bursts of XP to nearby pets." caption="The Dilophosaurus spits venom for burst XP and cooldown reduction." />
          <p>
          ...
          <ArticleImage src="/images/wisp.jpg" alt="The Wisp pet flying near a Wisp Well cosmetic, which grants additional XP per second to all pets." caption="The Wisp requires the Wisp Well cosmetic to activate its XP boost." />
          <p>
          ...
          <ArticleImage src="/images/golden-piggy.jpg" alt="The Golden Piggy pet in Grow a Garden, which grants bonus XP to nearby pets based on the number of Gold Ingot cosmetics placed." caption="The Golden Piggy scales its XP boost with Gold Ingot cosmetics." />
          <p>
